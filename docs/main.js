(() => {
  ...
  const e = (() => {
    ...
    return (
      localStorage.getItem("defaultProjects") || (localStorage.setItem("defaultProjects", JSON.stringify([])), localStorage.getItem("projects") || localStorage.setItem("projects", JSON.stringify([]))),
      (() => {
        let e = n();
  ...
  const a = () => {
    ...
    o = () => {
      ...
      return (
        ...
        a.setAttribute("d", "M17.5 6.5h-11V18A1.5 1.5 0 0 0 8 19.5h8a1.5 1.5 0 0 0 1.5-1.5V6.5zm-9 0h7V5A1.5 1.5 0 0 0 14 3.5h-4A1.5 1.5 0 0 0 8.5 5v1.5z"),
        r.append(e, o, n, a),
        t.append(r),
        t
      );
    ...
    i = () => {
      ...
      return (
        ...
        n.setAttribute("d", "M4.42 16.03a1.5 1.5 0 00-.43.9l-.22 2.02a.5.5 0 00.55.55l2.02-.21a1.5 1.5 0 00.9-.44L18.7 7.4a1.5 1.5 0 000-2.12l-.7-.7a1.5 1.5 0 00-2.13 0L4.42 16.02z"),
        r.append(e, n, a),
        t.append(r),
        t
      );
      ...
      return {
        ...
        getTaskButton: (e) => {
          ...
          if (
            ...
            m.classList.add("task-button-edit-button", "task-button-action-button"),
  ...
  var f,
    p = {
      ...
      dateTime: g({ formats: { full: "{{date}} 'at' {{time}}", long: "{{date}} 'at' {{time}}", medium: "{{date}}, {{time}}", short: "{{date}}, {{time}}" }, defaultWidth: "full" }),
    },
  ...
  const lt = (() => {
    ...
    mt = (() => {
        ...
        o = (e, n) => {
          (() => {
            ...
            (() => {
              ...
              a.setAttribute("d", "M6 6V.5a.5.5 0 0 1 1 0V6h5.5a.5.5 0 1 1 0 1H7v5.5a.5.5 0 1 1-1 0V7H.5a.5.5 0 0 1 0-1H6z"),
            ...
            document.querySelector(".editor-add-task-button").addEventListener("click", () => lt.toggleModal()),
            s(e),
            r(e);
        },
        i = (e) => {
      ...
      return (
        ...
        { addSidebarVisibleClass: () => t.classList.add("is-sidebar-visible"), addNewTaskButton: i, changeContent: o, removeSidebarVisibleClass: () => t.classList.remove("is-sidebar-visible"), loadEmptyStateIfProjectEmpty: r }
      );
    })(),
    ht = (() => {
          ...
          for (const a of e)
            a.addEventListener("click", () => {
              t.classList.toggle("is-visible"),
                ...
                t.classList.contains("is-visible") ? ht.changeMenuTooltipTextClose() : ht.changeMenuTooltipTextOpen();
            });
        })(),
        (() => {
          ...
          ((t) => {
            ...
            ((t) => {
              const n = t.dataset.tabName,
                a = t.childNodes[2];
              t.addEventListener("click", (e) => e.target === t && mt.changeContent(e.target, n)),
                a.addEventListener("click", () => {
                  gt.selectDefaultTab();
